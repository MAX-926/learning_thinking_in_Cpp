...
{
    public:
        Math& operator*(Math& rv){ return rv.multiply(this); /*2nd dispatch*/ }
...
class Tensor:public Math
{
    public:
        Math& operator*(Math& rv){return rv.multiply(this);}
        Math& multiply(Matrix*){cout << "Tensor * Matrix" << endl; return *this;}
        Math& multiply(Scalar*){cout << "Tensor * Scalar" << endl; return *this;}
        Math& multiply(Vector*){cout << "Tensor * Vector" << endl; return *this;}
        Math& multiply(Tensor*){cout << "Tensor * Tensor" << endl; return *this;}
};
